...
public class HTTPRequestLine {
	...
	public boolean setBody(String body){
		...
		HashMap<String, Object> json = jsonStringToMap(body);
		if (json == null){
			return false;
		}
...
//			} else if (keyString.equals("Port")){
//				this.parameters.put(keyString, json.get(key));
//			} else if (keyString.equals("secondaries")){
//				this.parameters.put(keyString, json.get(key));
...
//			} 
//			
//			else if (keyString.equals("tweet")){
...
//	}
	...
	private HashMap<String, Object> jsonStringToMap(String jsonString){
		...
		try {
			jsonMap = (HashMap<String, Object>)parser.parse(jsonString, containerFactory);
